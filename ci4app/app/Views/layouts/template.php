...
<!-- Bootstrap 4 -->
<script src="<?= base_url('plugins/bootstrap/js/bootstrap.bundle.min.j'); ?>s"></script>
<!-- ChartJS -->
...
<script src="<?= base_url('plugins/jqvmap/maps/jquery.vmap.usa.j'); ?>s"></script>
<!-- jQuery Knob Chart -->
<script src="<?= base_url('plugins/jquery-knob/jquery.knob.min.j'); ?>s"></script>
<!-- daterangepicker -->
<script src="<?= base_url('plugins/moment/moment.min.js'); ?>"></script>
<script src="<?= base_url('plugins/daterangepicker/daterangepicker.j'); ?>s"></script>
...
<script>
  ...
  if (flashdata == 'Data berhasil ditambahkan.') {
    Swal.fire(
      'Berhasil!',
      flashdata,
      'success'
